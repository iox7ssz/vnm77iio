...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("AlinaXIQ/assets/font2.ttf", 30)
    font = ImageFont.truetype("AlinaXIQ/assets/font.ttf", 30)
    title_font = ImageFont.truetype("AlinaXIQ/assets/font.ttf", 45)
    ...
    play_icons = Image.open("AlinaXIQ/assets/play_icons.png")
